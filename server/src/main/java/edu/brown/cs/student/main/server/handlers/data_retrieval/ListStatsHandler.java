...
public class ListStatsHandler implements Route {
   ...
   */
  public ListStatsHandler(FirebaseUtilities storageHandler) {
  ...
  public Object handle(Request request, Response response) throws Exception {
    ...
    try {
      ...
      Algorithm alg = new Algorithm(this.storageHandler);
      String[] stats = alg.getBasicStats(uid);
