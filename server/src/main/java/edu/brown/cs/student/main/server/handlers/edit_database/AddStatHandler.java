...
public class AddStatHandler implements Route {
  ...
  public AddStatHandler(FirebaseUtilities storageHandler) {
  ...
  public Object handle(Request request, Response response) {
    ...
    try {
      ...
      // TODO: use algorithm to get a new stat
      String stat = "99% of users also listen to taylor swift.";
      ...
      this.storageHandler.addStat(uid, stat);

      responseMap.put("response_type", "success");
      responseMap.put("stat", data);
    } catch (Exception e) {
